...
from app.services.llm_service import extract_information_from_message, generate_conversation_response
...
async def script_generation_node(state: SessionState) -> SessionState:
    ...
    try:
        ...
        if state.get("needs_refinement"):
            ...
            context["low_confidence_claims"] = fact_check_results.get("low_confidence_claims", [])
