...
class Settings(BaseSettings):
    ...
    redis_ssl: bool = False  # Enable SSL/TLS for Redis (required for Upstash)
    ...
    general_model_provider: str = (
        "openai"  # Provider for general model: "openai" or "curricullm"
    )
    ...
    curriculum_model_provider: str = (
        "curricullm"  # Provider for curriculum model: "curricullm" or "openai"
    )
